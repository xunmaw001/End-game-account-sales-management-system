...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">平台费用管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>平台费用管理</span></li>
								<li class="breadcrumb-item active"><span>平台费用列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">平台费用列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										卖家姓名
									</label>
									<input type="text" id="maijiaxingmingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('dingdanhao')">订单号<i id="dingdanhaoIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('pingtaifeiyong')">平台费用<i id="pingtaifeiyongIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#maijiaxingmingSearch').val() != null && $('#maijiaxingmingSearch').val() != ''){
				searchForm.maijiaxingming ="%" +  $('#maijiaxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("pingtaifeiyong/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				maijiaxingming : searchForm.maijiaxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var dingdanhaoCell  = document.createElement('td');

						 dingdanhaoCell.innerHTML = item.dingdanhao;


			row.appendChild(dingdanhaoCell);
			...
			var pingtaifeiyongCell  = document.createElement('td');

						 pingtaifeiyongCell.innerHTML = item.pingtaifeiyong;


			row.appendChild(pingtaifeiyongCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("pingtaifeiyong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("pingtaifeiyong"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"pingtaifeiyong");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"pingtaifeiyong");
