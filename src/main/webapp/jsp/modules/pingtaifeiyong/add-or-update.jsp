		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑平台费用</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑平台费用</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">平台费用信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>订单号</label>
										<input id="dingdanhao" name="dingdanhao" class="form-control" placeholder="订单号">
									</div>
									<div class="form-group col-md-6">
										<label>标题</label>
									...
									<div class="form-group col-md-6">
										<label>添加时间</label>
										<input id="tianjiashijian" name="tianjiashijian" class="form-control" placeholder="添加时间">
									</div>
									<div class="form-group col-md-6">
										<label>卖家姓名</label>
									...
									<div class="form-group col-md-6">
										<label>平台费用</label>
										<input id="pingtaifeiyong" name="pingtaifeiyong" class="form-control" placeholder="平台费用">
									</div>
									<div class="form-group col-md-6">
										<label>备注</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "pingtaifeiyong/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("pingtaifeiyong/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("pingtaifeiyong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.dingdanhao != null && res.data.dingdanhao != ''){

					$("#dingdanhao").val(res.data.dingdanhao);
					}
					...
					$("#tianjiashijian").val(res.data.tianjiashijian);
					}
					...
					if(res.data != null && res.data != '' && res.data.pingtaifeiyong != null && res.data.pingtaifeiyong != ''){

					$("#pingtaifeiyong").val(res.data.pingtaifeiyong);
					}
