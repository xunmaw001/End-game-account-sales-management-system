...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>购买订单管理</span></li>
								<li class="breadcrumb-item active"><span>购买订单列表</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "平台费用"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"pingtaifeiyong\")");
			if(crossBtnControl('平台费用') == true){
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("goumaidingdan/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("goumaidingdan/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("goumaidingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("goumaidingdan"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"goumaidingdan");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"goumaidingdan");
