...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑购买订单</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>订单号</label>
										<input id="dingdanhao" name="dingdanhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>标题</label>
									...
									<div class="form-group col-md-6">
										...
										<div id="goumaishijianDate" class="input-append date form_datetime">
											<input id="goumaishijian-input" name="goumaishijian" size="15" type="text" readonly>
	...
	<script>
		...
		var crossRuleForm = {};
			...
			function dingdanhaoUuid(){
				if($("#dingdanhao").val() == null || $("#dingdanhao").val() == "null" || $("#dingdanhao").val() == ""){
					$("#dingdanhao").attr("value",Math.round(new Date().getTime()/1000));
				}
			}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "goumaidingdan/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("goumaidingdan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
