        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">广告信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('guanggaoxinxi','新增')" @click="jump('../guanggaoxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../guanggaoxinxi/detail.jsp?id='+item.id)">
                      <a href="#" class="ng-prsliik">
                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                          <img :src="item.guanggaotupian?item.guanggaotupian.split(',')[0]:''" />
                        </span>
                    ...
                    <div class="ng-prslist-tit" @click="jump('../guanggaoxinxi/detail.jsp?id='+item.id)"><span>{{item.guanggaobiaoti}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#guanggaobiaoti').val()) {
          param['guanggaobiaoti'] = jquery('#guanggaobiaoti').val() ? '%' + jquery('#guanggaobiaoti').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('guanggaoxinxi/list', 'get', param, function(res) {
