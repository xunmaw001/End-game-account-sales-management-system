				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>广告内容：</span>
							<span class="desc">
								{{detail.guanggaoneirong}}
							</span>
						</div>
																								<div class="detail-item">
							<span>广告分类：</span>
							<span class="desc">
								{{detail.guanggaofenlei}}
							</span>
						</div>
																								<div class="detail-item">
							<span>发布时间：</span>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`guanggaoxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.guanggaobiaoti;
																				// 轮播图片
					vue.swiperList = vue.detail.guanggaotupian ? vue.detail.guanggaotupian.split(",") : [];
																																													var swiperItemHtml = '';
