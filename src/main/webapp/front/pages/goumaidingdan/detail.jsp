				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('goumaidingdan','平台费用')" @click="onAcrossTap('pingtaifeiyong')" type="button" class="layui-btn">
								平台费用
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`goumaidingdan`);
